...
SELECT customer_id, first_name, last_name FROM customer WHERE first_name = 'Hiren' AND last_name = 'Patel';
...
UPDATE customer
SET first_name = 'Krishna', last_name = 'Bamaniya', email = 'krishna.bamaniya@tatvasoft.com'
WHERE customer_id = 1;
